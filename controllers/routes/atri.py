...
class Atri:
	...
	@property
	def Div(self):
		self._getter_access_tracker["Div"] = {}
		return self._Div
	@Div.setter
	def Div(self, new_state):
		self._setter_access_tracker["Div"] = {}
		global default_state
		self._Div = Div(new_state, default_state["Div"])
